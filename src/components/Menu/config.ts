...
const config: MenuEntry[] = [
  {
    label: 'Home',
    icon: 'HomeIcon',
    href: 'https://dark.knightswap.financial',
  }, 
  {
    label: 'Trade',
    icon: 'TradeIcon',
  ...
  },
  {
    label: 'Farms',
    icon: 'FarmIcon',
    href: 'https://dark.knightswap.financial/farms',
  },
  // {
  //   label: 'Nests',
  //   icon: 'PoolIcon',
  ...
  // },
  {
    label: 'Pools',
    icon: 'PoolIcon',
    href: 'https://dark.knightswap.financial/pools',
  },
  ...
  },
  {
    label: 'IUO',
    icon: 'IfoIcon',
    href: 'https://dark.knightswap.financial/iuo',
  },
  // {
  //   label: 'Lottery',
  //   icon: 'TicketIcon',
